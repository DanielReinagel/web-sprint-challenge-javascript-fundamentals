...
/* When an inner function is called, first, the function checks to see if the variable is defined in the function. Then, it checks to see if the function it's in has the variable(which it does).
Then, it continues checkout outer functions until there are none left, in which case it checks to see if the variable exists as a global variable. */
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    return array.reduce((acc, item) => acc+item.population, 0);
  }
